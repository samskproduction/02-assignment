...
const page = () => {
  return (
    ...
    <div className="flex flex-col mt-10 ">
        ...
        <p className='max-w-screen-lg  text-3xl px-2.5 py-2.5 mt-5 text-black'>
        I m a frontend developer, passionate about technology and creating innovative solutions.
        </p>
    </div>
    <div className=''>
<Image className ="relative top-12 w-[25vw] rounded-full h-[25vw] object-cover mt-10 left-56 cursor-pointer ease-in-out[0.4s]]"
src={img} 
alt='img' />
</div>
    </section>
